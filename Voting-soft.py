...
voting_estimator = ensemble.VotingClassifier(estimators=[('dt', dt_estimator), ('rf', rf_estimator), ('ada', ada_estimator)], voting='soft', weights=[1,2,4])
voting_grid = {'dt__max_depth':[3,5,7], 'rf__n_estimators':[10], 'rf__max_features':[6,10,14], 'rf__max_depth':[5], 'ada__n_estimators':[5], 'ada__learning_rate':[0.2,0.3,0.4]}
...
titanic_test.to_csv('submission_SoftVoting2.csv', columns=['PassengerId','Survived'],index=False)
