...
voting_grid = {'dt__max_depth':[3,5,7], 'rf__n_estimators':[20], 'rf__max_features':[5,7,9], 'rf__max_depth':[2,4,6], 'ada__n_estimators':[20]}
grid_voting_estimator = model_selection.GridSearchCV(voting_estimator, voting_grid,verbose = 1, cv=10, n_jobs=6)
...
titanic_test.to_csv('submission_Voting2.csv', columns=['PassengerId','Survived'],index=False)
